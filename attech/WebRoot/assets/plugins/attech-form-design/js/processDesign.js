...
$(function() {
	 ...
	 */
	var flowId = Attech.app.g('flowId');
	...
	var wfInter = {
		...
		init: function(callback) {			
			 var url = Attech.app.url("static/data/flowJson.txt"),param = {flowid: flowId};
			 $container.waiting(U.lang('WF.LOADING_PROCESS'));
			 var res = '{"isSuccess":true,"data":[{"id":247,"processid":33,"left":"720","top":"88","name":"\u5206\u7ba1\u9886\u5bfc","to":"4"},{"id":249,"processid":5,"left":"589","top":"379","name":"\u8463\u4e8b\u957f","to":"0"},{"id":248,"processid":4,"left":"389","top":"338","name":"\u603b\u7ecf\u7406","to":"5,2,1,33"},{"id":32,"processid":2,"left":"89","top":"143","name":"\u8d22\u52a1\u5ba1\u6279","to":"33"},{"id":30,"processid":1,"left":"305","top":"37","name":"\u5e38\u7528\u5907\u7528\u91d1\u7533\u8bf7","to":"2"},{"id":29,"processid":0,"left":"80","top":"211","name":"\u7ed3\u675f","to":""},{"id":28,"processid":-1,"left":"26","top":"23","name":"\u5f00\u59cb","to":"1"}]}';
		...
		addStep: function(data, callback) {
			 var url = Attech.app.url("workflow/process/add");
			 $.post(url, $.extend({ flowid: flowId, formhash: Attech.app.g('formHash') }, data), callback, 'json');
		},
		/**
		 * 读取编辑页面
		...
		getStepEdit: function(processId, op, callback) {
			 var url = Attech.app.url("workflow/process/edit");
			 	param = {
			 		flowid: flowId,
			 		processid: processId,
			 		op: op
		...
		removeStep: function(processId, callback) {
			 var url = Attech.app.url("workflow/process/del"),
			 	param = {
		...
		save: function(data, callback) {
			 var url = Attech.app.url("workflow/process/saveview"),
			 	param = {
			 		flowid: flowId,
			 		data: data,
					formhash: Attech.app.g('formHash')
	...
	var infoBar = (function() {
		...
		return {
			...
			loadContent: function(param){
				...
				$.post(Attech.app.url('workflow/process/getprocessinfo'), param, function(res){
					if (res.isSuccess) {
						$container.stopWaiting();
