...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
		,imageUrl: Attech.app.url("main/editor/imageUp")       //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        ,fileUrl:Attech.app.url("main/editor/fileUp")        //附件上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:Attech.app.url("main/editor/imageManager")       //图片在线管理的处理地址
        ,imageManagerPath:''                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: Attech.app.url("main/editor/imageUp") //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: ''
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:Attech.app.url("main/editor/imageUp")             //word转存提交地址
        ,wordImagePath:''                       //
