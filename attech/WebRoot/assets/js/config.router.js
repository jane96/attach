...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
   ...
   .state('app.myformupload', {
	...
	.state('app.pages.users', {
     ...
     .state('app.pages.group', {
 		...
 		resolve: loadSequence('flow', 'userCtrl', 'selectCtrl','ui.select', 'ngTable','asideCtrl','angularBootstrapNavTree', 'treeCtrl') 
          ...
          url: '/exampleList/:bussiType',
          templateUrl: "pages/example/exampleList.html",
          title:'表单实例查询',
          icon: 'ti-layout-media-left-alt',
  		resolve: loadSequence('flow', 'userCtrl', 'selectCtrl','ui.select', 'ngTable','asideCtrl','angularBootstrapNavTree', 'treeCtrl') 
       })
       .state('app.pages.secureList', {
          url: '/secureList/:bussiType',
          templateUrl: "pages/project/secureList.html",
          title:'保险管理',
          icon: 'ti-layout-media-left-alt',
  		resolve: loadSequence('ui.select', 'ngTable','asideCtrl','angularBootstrapNavTree', 'treeCtrl') 
       })
       .state('app.pages.appropriationsList', {
          url: '/appropriationsList/:bussiType',
          templateUrl: "pages/project/appropriationsList.html",
          title:'拨款管理',
          icon: 'ti-layout-media-left-alt',
  		resolve: loadSequence('ui.select', 'ngTable','asideCtrl','angularBootstrapNavTree', 'treeCtrl') 
       })
    ...
    .state('app.workflow.flowStart', {
        ...
        resolve: loadSequence('ngFileUpload','ui.select', 'angularFileUpload')
     })
     .state('app.workflow.flowDeal', {
        ...
        resolve: loadSequence('ngFileUpload', 'angularFileUpload')
     })
     .state('app.workflow.formDeal', {
        url: '/formDeal',
        templateUrl: "pages/workflow/formDesign/formDeal.html",
        title: '表单处理',
        icon: 'ti-layout-media-left-alt',
        params: {
        	'formObj': null
     ...
     .state('app.workflow.formPreView', {
        url: '/formPreView/:tempId',
        templateUrl: "pages/workflow/formDesign/formPreView.html",
        title: '表单预览',
        icon: 'ti-layout-media-left-alt',
        resolve: loadSequence('ngFileUpload', 'angularFileUpload')
     })
	.state('app.workflow.formDesign', {
        ...
        title: '表单设计',
        icon: 'ti-layout-media-left-alt',
		resolve: loadSequence('ui.select', 'ngTable','angularBootstrapNavTree') 
     })
     .state('app.workflow.formSave', {
		...
		resolve: loadSequence('ngTable','ngFileUpload','angularFileUpload') 
     })
     .state('app.ui', {
        url: '/ui',
        template: '<div ui-view class="fade-in-up"></div>',
        ...
        resolve: loadSequence('ui.select', 'monospaced.elastic', 'ui.mask', 'touchspin-plugin', 'selectCtrl','angularBootstrapNavTree', 'jquery-nestable-plugin')
...
//      resolve: loadSequence('asideCtrl'),
    ...
    .state('app.pages.handle', {
     ...
     }).state('app.pages.sealManage', {
         url: '/sealManage/:bussiType',
         templateUrl: "pages/pages_sealManage.html",
         title: '印章管理',
         ncyBreadcrumb: {
             label: 'User Profile'
         },
         resolve: loadSequence('flow', 'userCtrl','ngTable','angularBootstrapNavTree')
      }).state('app.pages.papersManage', {
          url: '/papersManage/:bussiType',
          templateUrl: "pages/pages_papersManage.html",
          title: '证件管理',
          ncyBreadcrumb: {
              label: 'User Profile'
          },
          resolve: loadSequence('flow', 'userCtrl','ngTable','angularBootstrapNavTree')
       }).state('app.pages.transferManage', {
          url: '/transferManage/:bussiType',
          templateUrl: "pages/pages_transferManage.html",
          title: '人员调动管理',
          ncyBreadcrumb: {
              label: 'User Profile'
          },
	...
	.state('app.pages.sendDoc', {
	    url: '/sendDoc/:bussiType',
	    templateUrl: "pages/doc/sendDoc.html",
        title: '发文管理',
  		resolve: loadSequence('flow', 'userCtrl', 'selectCtrl','ui.select', 'ngTable','asideCtrl','angularBootstrapNavTree', 'treeCtrl'), 
        icon: 'ti-layout-media-left-alt'
	})
	.state('app.pages.sendDocFlowStart', {
        url: '/sendDocFlowStart',
        templateUrl: "pages/doc/sendDocFlowStart.html",
        title: '发文拟稿',
        icon: 'ti-layout-media-left-alt',
        params: {
        	'flowObj': null
	...
	.state('app.pages.bidManagement', {
	    url: '/bidManagement',
	    templateUrl: "pages/bidManagement.html",
        title: '单位基础信息管理',
        resolve: loadSequence('ngTable','angularBootstrapNavTree','userCtrl','flow','ui.select'),
        icon: 'ti-layout-media-left-alt'
	});
