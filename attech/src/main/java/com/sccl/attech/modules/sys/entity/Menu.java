...
public class Menu extends IdEntity<Menu> {
	...
	private String isMobile;   //是否手机显示（1：同步；0：不同步）
	private String permission; // 权限标识
	private String plugins;//加载插件
	...
	public Menu(String parentIds, String name, String href, String target, String icon, Integer sort, String isShow,
			String isActiviti, String isMobile, String permission, String plugins, String parentId) {
		super();
	...
	public String getIsShowName() {
		return DictUtils.getDictLabel(isShow, "show_hide", "无");
	}
	...
	public String toString() {
		...
		.append("name", this.name).append("href", this.href).append("isMobile", this.isMobile).toString();
	}
