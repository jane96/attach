/**
 * @(#)Collections3.java     1.0 11:41:12
...
public class Collections3 {
	...
	/**
	 * Extract to list as map.
	 * 将list 中的一些属性组装成map
	 * @param collection the collection
	 * @param propertys the propertys
	 * @return the 列表
	 */
	public static List<Map<String, Object>> extractToListAsMap(final Collection collection,final String[] propertys) {
